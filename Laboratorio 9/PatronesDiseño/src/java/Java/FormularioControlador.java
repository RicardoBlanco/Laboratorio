...
public class FormularioControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(comparacion == true){
                response.sendRedirect("FormularioResultados.jsp?nombre="+formulario.getNombre()+"&primer="+formulario.getPrimer()+"&segundo="+formulario.getSegundo()+"&correo="+formulario.getCorreo()+"&fecha="+formulario.getFecha()+"&password="+formulario.getPassword()+"&empleo="+empleo);
            }else{
                response.sendRedirect("FormularioError.jsp");
            }
